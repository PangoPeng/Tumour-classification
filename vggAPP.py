...
if os.path.exists(logo_path):
    ...
    <div class="title-container">
        ...
        <h1>CT IMAGE TUMOR DETECTION</h1>
    </div>
    """
    st.markdown(title_html, unsafe_allow_html=True)
else:
    st.warning("Logo file not found. Please check the file path.")
    st.markdown("<h1>CT IMAGE TUMOR DETECTION</h1>", unsafe_allow_html=True)

def main():
    st.markdown('<p class="upload-text">Upload a CT Image for analysis:</p>', unsafe_allow_html=True)
    file_uploaded = st.file_uploader('Choose an image...', type=['png', 'jpg', 'jpeg', 'gif', 'bmp'])
...
<div class="footer">
    <p>Developed with ❤ by Xiayan Peng <a href="https://github.com/yourusername" target="_blank"></a></p>
</div>
"""
